...
#if defined(NDEBUG)
# error "WOOLFCOIN cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xca4f78f1db4d9749559b4c26d0daf4bd0ad0bdd7438aaf9be1d8dd8ebd01df93");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // WOOLFCOIN: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "WOOLFCOIN Signed Message:\n";
...
{
    // WOOLFCOIN: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // WOOLFCOIN: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // WOOLFCOIN: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xca4f78f1db4d9749559b4c26d0daf4bd0ad0bdd7438aaf9be1d8dd8ebd01df93");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1432640164, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "26/May/2015 NFHF";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1432640164;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1214725;
        ...
        assert(block.hashMerkleRoot == uint256("0xfd7bf7f75bb78d97976592783de464d64d04953fe2618cfb72b5801b59ebdad2"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // WOOLFCOIN: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("WOOLFCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("WOOLFCOINMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static WOOLFCOINMiner(CWallet *pwallet)
{
    printf("WOOLFCOINMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("woolfcoin-miner");
    ...
    try { loop {
        ...
        printf("Running WOOLFCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("WOOLFCOINMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&WOOLFCOINMiner, pwallet));
}
